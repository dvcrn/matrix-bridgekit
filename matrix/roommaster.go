...
func (rm *RoomManager) NewRoom(name string, topic string, ghosts ...*domain.Ghost) *domain.Room {
	return domain.NewRoom(name, topic, rm.bridge.Bot, ghosts...)
}

func (rm *RoomManager) CreatePersonalSpace(ctx context.Context, user *domain.User, name string, topic string) (*mautrix.RespCreateRoom, error) {
...
func (rm *RoomManager) AddRoomToUserSpace(ctx context.Context, spaceID id.RoomID, room *domain.Room) error {
...
func (rm *RoomManager) AddUserToRoom(ctx context.Context, roomID id.RoomID, user *domain.User) error {
...
func (rm *RoomManager) SetRoomAvatar(ctx context.Context, room *domain.Room, intent *appservice.IntentAPI, url id.ContentURI) error {
	_, err := intent.SetRoomAvatar(ctx, room.MXID, url)
	return err
}

func (rm *RoomManager) InsertSetRoomAvatarEvent(ctx context.Context, room *domain.Room, intent *appservice.IntentAPI, url id.ContentURI, ts int64) error {
...
func (rm *RoomManager) UploadRoomAvatar(ctx context.Context, room *domain.Room, intent *appservice.IntentAPI, url string) (id.ContentURI, error) {
...
func (rm *RoomManager) LoadRoomIntent(room *domain.Room) {
